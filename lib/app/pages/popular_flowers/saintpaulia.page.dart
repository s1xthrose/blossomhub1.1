...
class SaintpauliaPage extends StatelessWidget {
  @override
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: AssetImage('assets/s_flower.png'),
                        fit: BoxFit.cover,
                      ),
                      boxShadow: [
                        BoxShadow(
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text('from 1 cm to 15 cm', style: GoogleFonts.nunito(
                        textStyle: TextStyle(
                          fontSize: ScreenUtil().setSp(13),
                          color: Colors.black,
                          fontWeight: FontWeight.w400,
                      ...
                      Text('January to December', style: GoogleFonts.nunito(
                        textStyle: TextStyle(
                          fontSize: ScreenUtil().setSp(13),
                          color: Colors.black,
                          fontWeight: FontWeight.w400,
                      ...
                      Text('light, loose and airy', style: GoogleFonts.nunito(
                        textStyle: TextStyle(
                          fontSize: ScreenUtil().setSp(13),
                          color: Colors.black,
                          fontWeight: FontWeight.w400,
                      ...
                      Text('medium', style: GoogleFonts.nunito(
                        textStyle: TextStyle(
                          fontSize: ScreenUtil().setSp(13),
                          color: Colors.black,
                          fontWeight: FontWeight.w400,
